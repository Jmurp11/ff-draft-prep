...
import { ApolloAngularSDK, Exact, FolderArgs, FoldersDocument, NoteInput, NotesDocument, TargetInput } from '../sdk/generated/graphql';
...
export class PopUpService {
  ...
  createNoteMutation(note: Exact<NoteInput>) {
    this.subSink.add(
